            ...
            val stringRequest =
                object : StringRequest(Method.POST, url, Response.Listener { response ->
                    ...
                    if (response.equals("success")) {
                        Toast.makeText(
                            holder.itemView.context, "Booking Confirmed", Toast.LENGTH_SHORT
                        ).show()
                        bookingCommunicator.confirmedBooking(currentTransaction)
                    } else {
                        Toast.makeText(
                            holder.itemView.context, response, Toast.LENGTH_SHORT
                        ).show()
                    }
        ...
        holder.cancelButton.setOnClickListener {
            ...
            val stringRequest =
                object : StringRequest(Method.POST, url, Response.Listener { response ->
                    ...
                    if (response.equals("success")) {
                        Toast.makeText(
                            holder.itemView.context, "Booking Canceled", Toast.LENGTH_SHORT
                        ).show()
